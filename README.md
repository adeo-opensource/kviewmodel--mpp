...
```kotlin
implementation("com.adeo:kviewmodel:0.7") // Core functions
implementation("com.adeo:kviewmodel-compose:0.7") // Compose extensions
implementation("com.adeo:kviewmodel-odyssey:0.7") // Odyssey extensions
```
